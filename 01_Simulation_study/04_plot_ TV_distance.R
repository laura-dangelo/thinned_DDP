...
#       
#       namesave = paste0("../04_Simulation_commonatoms/Results/true_density_", n_groups[i], "groups_", sum(n_groups[i]/2*ssg*j), "n_", repl,".Rdata")
#       save(truth, file = namesave)
#       
#       TV_thinnedDDP = 0
...
#       
#       newdata = c("thinnedDDP", n_groups[i], sum(n_groups[i]/2*ssg*j), TV_thinnedDDP)
...
# 
# saveRDS(TVdist_df, file = "../04_Simulation_commonatoms/output_RDS/TVdist_df_models.RDS")

TVdist_df = readRDS("../04_Simulation_commonatoms/output_RDS/TVdist_df_models.RDS")
...
ggsave("../04_Simulation_commonatoms/04_02_TVdistance.pdf", width = 8, height = 4)
...
# 
#       newdata = c("pool", n_groups[i], sum(n_groups[i]/2*ssg*j), TV_pool)
#       TVdist_df2[nrow(TVdist_df2)+1,] = newdata
# 
# 
# 
...
# 
#       newdata = c("no-pool", n_groups[i], sum(n_groups[i]/2*ssg*j), TV_nopool)
#       TVdist_df2[nrow(TVdist_df2)+1,] = newdata
#       
#     }
#   }
...
# 
# 
# saveRDS(TVdist_df2, file = "../04_Simulation_commonatoms/output_RDS/TVdist_df_pool.RDS")

TVdist_df2 = readRDS("../04_Simulation_commonatoms/output_RDS/TVdist_df_pool.RDS")
...
ggsave("../04_Simulation_commonatoms/04_01_TVdistance.pdf", width = 8, height = 4)
