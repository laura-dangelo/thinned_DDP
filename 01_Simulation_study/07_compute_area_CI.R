...
# This script produces Figures F4 and F5 of the Supplementary Material.
...
if(!file.exists("01_Simulation_study/output_RDS/area_df_pool.RDS")){
...
if(!file.exists("01_Simulation_study/output_RDS/area_df_models.RDS")) {
