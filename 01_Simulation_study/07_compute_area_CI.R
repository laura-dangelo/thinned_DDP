...
#       
#       newdata = c("thinnedDDP", n_groups[i], sum(n_groups[i]/2*ssg*j), area_CI_thinnedDDP)
...
# 
# saveRDS(area_df, file = "../04_Simulation_commonatoms/output_RDS/area_df_models.RDS")

area_df = readRDS("../04_Simulation_commonatoms/output_RDS/area_df_models.RDS")
...
ggsave("../04_Simulation_commonatoms/07_02_areaCI.pdf", width = 8, height = 4)
...
# 
#       newdata = c("pool", n_groups[i], sum(n_groups[i]/2*ssg*j), area_CI_pool)
#       area_df2[nrow(area_df2)+1,] = newdata
# 
#       #-----# #-----# #-----# #-----#
#       #-----#     No pool     #-----#
...
# 
#       newdata = c("no-pool", n_groups[i], sum(n_groups[i]/2*ssg*j), area_CI_nopool)
#       area_df2[nrow(area_df2)+1,] = newdata
#       
#       
#       
...
# 
# saveRDS(area_df2, file = "../04_Simulation_commonatoms/output_RDS/area_df_pool.RDS")

area_df2 = readRDS("../04_Simulation_commonatoms/output_RDS/area_df_pool.RDS")
...
ggsave("../04_Simulation_commonatoms/07_01_areaCI.pdf", width = 8, height = 4)
